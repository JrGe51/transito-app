...
Solicitud.init({
    Sid: { type: sequelize_1.DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
    SfechaSolicitud: { type: sequelize_1.DataTypes.DATEONLY, allowNull: false },
    id_usuario: { type: sequelize_1.DataTypes.INTEGER, references: { model: user_1.User, key: 'Uid' }, allowNull: false },
    id_tipoLicencia: { type: sequelize_1.DataTypes.INTEGER, references: { model: licencia_1.Licencia, key: 'Lid' }, allowNull: false },
    id_horario: { type: sequelize_1.DataTypes.INTEGER, references: { model: horario_1.Horario, key: 'Hid' }, allowNull: false },
}, {
